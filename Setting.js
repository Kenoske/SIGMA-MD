...
global.sudo  =  process.env.SUDO || "918731030752" ;          // DON'T REMOVE
global.mztit = process.env.MZTIT ||"𝐀𝐒𝐏𝐈𝐑𝐀𝐍𝐓",               // ADD YOUR TITLE, ONE WORD WILL BE MORE BETTER
global.gurl  = 'https://youtube.com/@Mr_Answer_Official' ; 
...
module.exports = {
  ...
  botname: process.env.BOT_NAME       || '𝐀𝐬𝐩𝐢𝐫𝐚𝐧𝐭 𝐁𝐨𝐭',         // ADD YOUR BOT NAME
  ownername:  process.env.OWNER_NAME  || `𝐀𝐬𝐩𝐢𝐫𝐚𝐧𝐭`, // ADD YOUR NAME
  ...
  //==============================[WHAT'SAPP FEATURES]==============================
  author:  process.env.PACK_AUTHER  || '𝐀𝐬𝐩𝐢𝐫𝐚𝐧𝐭',      // ADD YOUR STICKER AUTHOR NAME
  ...
  packname:  process.env.PACK_NAME  || "𝐀𝐬𝐩𝐢𝐫𝐚𝐧𝐭 𝐁𝐨𝐭" ,          // ADD YOUR STICKER PACKNAME
